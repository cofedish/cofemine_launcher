...
CofeMine Launcher 者，開源之礦藝啟者也。能理改囊，善於遊戲之自定，且自動安裝諸如 Forge、NeoForge、Cleanroom、Fabric、Quilt、LiteLoader、OptiFine 諸改囊，亦可製作改囊集，界面亦可隨意更易。

CofeMine Launcher 跨域甚廣。無論 Windows、Linux、macOS、FreeBSD 諸常見械綱，抑或 x86、ARM、RISC-V、MIPS、LoongArch 諸大構處理器，皆可運行。
君可憑此，於諸算機間自如遊戲。

若欲詳知 CofeMine Launcher 於諸算機之支援，請觀[此表](PLATFORM_zh_Hant.md)。

## 下載

請自 [CofeMine Launcher 官網](https://cofemine.ru) 取其最新版。
...
| 參數                                           | 解釋                                                      |
|----------------------------------------------|---------------------------------------------------------|
| `-Dhmcl.home=<path>`                         | 易 CofeMine Launcher 之用戶目錄                                            |
...
| `-Dhmcl.update_source.override=<url>`        | 易 CofeMine Launcher 之更新所                                             |
